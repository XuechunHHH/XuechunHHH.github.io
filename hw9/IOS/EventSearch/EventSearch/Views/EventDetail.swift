...
struct EventDetail: View {
    ...
    func getEventDetail() {
        cnt = 0
        AF.request("https://backend-dot-node-js-378101.wl.r.appspot.com/event?id=" + self.event["id"].string! ).responseJSON { response in
    ...
    func getArtistDetail(idx: Int){
        ...
        AF.request("https://backend-dot-node-js-378101.wl.r.appspot.com/artist", parameters: para, encoding: URLEncoding.default).responseJSON { response in
            switch response.result {
            case .success(let value):
    ...
    func getAlbum(idx: Int, id: String){
        ...
        AF.request("https://backend-dot-node-js-378101.wl.r.appspot.com/album", parameters: para, encoding: URLEncoding.default).responseJSON { response in
            switch response.result {
            case .success(let value):
    ...
    func getVenue(){
        ...
        AF.request("https://backend-dot-node-js-378101.wl.r.appspot.com/venue", parameters: para, encoding: URLEncoding.default).responseJSON { response in
            switch response.result {
            case .success(let value):
    ...
    func getMap() {
        ...
        let para = [
            "address": com,
            "key": "AIzaSyBPQYD1haDattmC5HT9njXNSyQIcELGw9Q"
        ]
