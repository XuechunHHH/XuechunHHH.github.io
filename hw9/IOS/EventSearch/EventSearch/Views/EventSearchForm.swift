...
struct EventSearchForm: View {
    ...
    func getSuggestions() {
        ...
        AF.request("https://backend-dot-node-js-378101.wl.r.appspot.com/suggest",parameters: para, encoding: URLEncoding.default).responseJSON { response in
    ...
    func search(lat: String, lng: String) {
        ...
        AF.request("https://backend-dot-node-js-378101.wl.r.appspot.com/search",parameters: para, encoding: URLEncoding.default).responseJSON { response in
            switch response.result {
            case .success(let value):
